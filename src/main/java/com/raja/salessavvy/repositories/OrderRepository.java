...
import com.raja.salessavvy.entities.Order;
import com.raja.salessavvy.entities.OrderStatus;
...
@Query("SELECT 0 FROM Order o WHERE YEAR(o.createdAt) = :year AND o.status = 'SUCCESS'")
